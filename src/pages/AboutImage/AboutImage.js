...
export const AboutImage = () => {
  ...
  const findData = (dataName, dataId) => {

    const findedDataName = dataName=="d-design" ? digitalDesingData : dataName=="photographs" ? photographsData : dataName=="branding" ?  brandingData : dataName=="h-draw" ? handDrawData : []

    const findData = findedDataName.find(item => item.id == dataId);
    setData(findData);
  }
  ...
  useEffect(() => {
    const dataName = id.split(":")[0]
    const dataId = id.split(":")[1]

    findData(dataName, dataId)
  }, [id]);
      ...
      <section className="about-image">
        <div className="container">
          <div className="about-image__wrap">
            <div className="about-image__imgbox">
              <img
              ...
              <div className="about-image__author">
                <h3 className="about-image__name">{data.title}</h3>
                <p className="about-image__desc">{data.desc}</p>
              </div>
            </div>

            <div className="about-image__ratings">
              <div className="about-image__rating-left">
                <h2 className="about-image__title">{data.title}</h2>
                <Rate
                  allowHalf
                  defaultValue={4.5}
            ...
            <form className="about-image__form" onSubmit={evt => {
              evt.preventDefault()
            }}>
              <TextArea
