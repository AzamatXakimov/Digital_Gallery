          ...
          <div className="header-inner">
                ...
                <li className="header-nav-item">
                  ...
                  <ul
                    ...
                    <li className="header-link-item">
                      <Link
                        className="header-nav-link dropw-down-link"
                        to="selected-by-categories/digital-design">
                        Raqamli dizayn
                      </Link>
                    </li>
                    <li className="header-link-item">
                      <Link
                        className="header-nav-link dropw-down-link"
                        to="selected-by-categories/photograph">
                        Fotosurat
                      </Link>
                    </li>
                    <li className="header-link-item">
                      <Link
                        className="header-nav-link dropw-down-link"
                        to="selected-by-categories/branding">
                        Brending
                      </Link>
                    </li>
                    <li className="header-link-item">
                      <Link
                        className="header-nav-link dropw-down-link"
                        to="selected-by-categories/hand-drawn-pictures">
            ...
            <div className="header-btn-box">
              ...
              <Link
                ...
                to={token.token ? "/profile" : "/login"}>
                {token.token ? "Profile" : "Kirish"}
              </Link>
            </div>
            ...
            <Drawer
              title={
                <span className="header-navbar-title">Digital Gallary</span>
              }
              placement={"left"}
              closable={false}
              onClose={onClose}
              ...
              <div className="header-navbar-btn-box">
                <button
                  className="header-navbar-theme-btn"
                  onClick={() => {
                    hendelChangeTheme();
                  }}>
                  <SunIcon />
                ...
                <Link
                  className="header-navbar-btn-link"
                  to={token.token ? "/profile" : "/login"}>
                  {token.token ? "Profile" : "Kirish"}
                </Link>
              </div>
